...
<nav class="w-full py-6 bg-white w-screen">
  <div class="flex items-center justify-between mx-auto xl:max-w-7xl lg:max-w-5xl md:max-w-3xl md:px-2 px-4">
    <section class="flex items-center text-gray-900 space-x-2">
      ...
      <a href="#" class="font-bold text-xl focus:ring focus:ring-purple-500 focus:ring-opacity-25 outline-none rounded-lg">ACADEMIC</a>
    </section>
    <section>
    ...
    <section>
      ...
      <ul class="md:flex hidden space-x-4">
                <li><a href="{{route('login')}}" class="bg-transparent  px-4 py-1 rounded-xl border-blue-500 border-2 text-blue-500 font-semibold hover:bg-gray-100 active:bg-gray-200 focus:ring focus:ring-purple-500 focus:ring-opacity-25 outline-none">Login</a></li>

        <li><a href="{{route('register')}}" class="bg-blue-500 px-4 py-1 rounded-xl border-blue-500 border-2 text-white hover:bg-blue-400 active:bg-blue-600 focus:ring focus:ring-purple-500 focus:ring-opacity-25 outline-none">Register</a></li>
